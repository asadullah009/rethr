  ...
  return (
    <div className="w-full h-full px-6 md:px-16">
      <div className=" flex flex-col w-[fit-content] box-sizing-border">
        ...
        <div className="py-4 inline-block break-words font-['Open_Sans'] font-normal text-sm md:text-lg leading-[1.5] text-tertiary">
          The Team&#39;s mission is to create a social creative metaverse that
          provides high engagement value among players, and where through
          gaming, they can experience the following:
          <br />
          <br />
          <div className="px-6">
            1) Immersive storytelling that provides players with exciting
            experiences in the battlefields;
            <br />
            2) Strategizing and battling against one another using their gaming
            prowess;
            <br />
            3) Colonizing planets to harvest resources in peace;
            <br />
            4) Breed/create new Rethr with unique features and better stats;
            and,
            <br />
            5) A Social Creative Metaverse Space where community members can
