...
const Article = () => {
  return (
    <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
      ...
      <h2 className="mb-2 text-2xl font-bold tracking-tight text-content-secondary">
      ...
      <div className="flex justify-between items-center">
        ...
        <a
          href="#"
          className="inline-flex items-center font-medium text-background-primary hover:underline"
        >
          Read more
          <svg
