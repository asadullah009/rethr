...
import Section from "@/src/components/pages/newsPage/Section";
...
export default function Mission() {
  ...
  return (
    <main className="flex justify-start items-center gap-8 flex-col lg:container mx-auto">
      <HeroSection label="Home / News" value="News" />
      <Heading label="News" />
